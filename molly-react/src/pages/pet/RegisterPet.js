      ...
      <div className={styles.board}>
        ...
        <div className={styles.info}>
          ...
          <label className={styles.radio}>
            <input type="radio" onClick={handleGenderButton} value="암컷" checked={!gender}/>
            <span>암컷</span>
            <input type="radio" onClick={handleGenderButton} value="수컷" checked={gender}/>
            <span>수컷</span>
          </label>
          <br />
          <h4>중성화</h4>
          <label className={styles.radio}>
            <input type="radio" onClick={handleNeuteredButton} value="함" checked={!neutered}/>
            <span>함</span>
            <input type="radio" onClick={handleNeuteredButton} value="안 함" checked={neutered}/>
            <span>안 함</span>
          </label>
          <br />
          <h4>수술이력</h4>
          <label className={styles.radio}>
            <input type="radio" onClick={handleSurgeryButton} value="있음" checked={!surgery}/>
            <span>있음</span>
            <input type="radio" onClick={handleSurgeryButton} value="없음" checked={surgery}/>
            <span>없음</span>
          </label>
          {!surgery ? 
